...
import { BarChart as BarChartIcon, Edit3, PlusCircle, Trash2, Home as HomeIcon } from "lucide-react"; // Renamed BarChart to BarChartIcon to avoid conflict
      ...
      <Card className="shadow-md rounded-lg">
        <CardHeader>
          <CardTitle className="text-xl flex items-center">
            <BarChartIcon className="mr-2 h-6 w-6 text-accent" />
            Resumen de Empresas
          </CardTitle>
